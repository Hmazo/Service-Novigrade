    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(txt_serviceName) || TextUtils.isEmpty(txt_servicePrice) || docList.size() == 0 || infoList.size() == 0) {
                    Toast.makeText(AdminAddService.this, "Please complete all required Fields", Toast.LENGTH_LONG).show();
                } else if (!InputTest.numberOrNot(txt_servicePrice)) {
                    Toast.makeText(AdminAddService.this, "Please enter a number as a price", Toast.LENGTH_LONG).show();
                } else {
        ...
        myref.setValue(service).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(AdminAddService.this,"error", Toast.LENGTH_LONG).show();
                }
            }
        });
